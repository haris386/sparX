...
>
  <div className="why-grid grid lg:grid-cols-2 gap-30 items-start"
    ...
    <div className="why-left space-y-6">
      ...
      <div className="why-cards flex flex-col gap-5">
        {[
          ...
          <div key={i} className="why-card bg-white rounded-[32px] p-3.5 flex flex-col gap-5">
  ...
  {/* Bottom Text */}
  <div className="why-bottom" style={{ margin: "auto", width: "80%", position: "relative" }}>
    <img src="/Icons/red-left.png" alt="red" className="object-contain left-el" />
    <h2
    ...
    <img src="/Icons/red-right.png" alt="red" className="object-contain right-el" />
  </div>
</section>
